package com.example.next.app.api.order.service;

import com.example.next.app.api.order.entity.Order;
import com.example.next.app.api.order.entity.OrderItem;
import com.example.next.app.api.order.repository.OrderRepository;
import com.example.next.app.api.order.repository.OrderItemRepository;
